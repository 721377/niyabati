...
<head>
    ...
    <link rel="stylesheet" href="css/bureau-absence.css">
    <title>مكتب الغيابات</title>
</head>
<body>

<section class="home">
<?php include 'sidebar-bureau-absence.php';?> 


        <h1 class="h1"> مكتب الغيابات المبررة و غير المبررة</h1>
...
<tbody>
    ...
    <td>المؤسسة</td>
        ...
        <div class="submit">
            ...
            <div class="del-save">
            <a class="del" href="types-bureau.php"><i class="bi bi-arrow-clockwise"></i>&nbsp; Retour</a>
            <a class="save" href="ajouter-bureau-absence.php"> <i class="bi bi-plus"></i>&nbsp; Ajouter</a>
            </div>
        </div>
</div>
</section>
