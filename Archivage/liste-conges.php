...
<head>
    ...
    <link rel="stylesheet" href="css/liste-conges.css">
    <title>login</title>
</head>
<body>
...
<Thead> 
        ...
        <th>قرارات</th>
        <th>الملاحظات</th>
        <th>رقم وتاريخ الإرسال إلى الأكاديمية</th>
        <th>تقرير الفحص المضاد</th>
        <th>الفحص المضاد</th>
        <th>الطبيب الذي قدم الفحص</th>
        <th>تنتهي بتاريخ</th>
        <th>:مؤرخة في</th>
        <th>مدتها</th>
        <th>رقمها</th>
    ...
    <td>المؤسسة</td>
        ...
        <div class="submit">
            ...
            <div class="del-save">
                ...
                <a class="save" href="gestionDeConge.php"> Ajouter un nouveau enregistrement</a>
            </div>
        </div>
